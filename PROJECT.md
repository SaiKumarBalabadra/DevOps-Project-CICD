# 🚀 **DevOps Real-time Project: Python Application**

In this **real-time DevOps project**, I demonstrate how to **deploy a python App** using various modern tools and services in the DevOps ecosystem.
...
4. **Pytest** ![Pytest]()
5. **Trivy** ![Trivy](https://img.shields.io/badge/Trivy-00979D?style=flat-square&logo=trivy&logoColor=white)
6. **Docker & DockerHub** ![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white) ![DockerHub](https://img.shields.io/badge/DockerHub-2496ED?style=flat-square&logo=docker&logoColor=white)
